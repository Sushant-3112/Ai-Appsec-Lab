        ...
        <div className="p-8 sm:p-12 bg-white">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-start">
              ...
              {/* Left Column: Heading & Official Google OAuth Trigger */}
              <div className="md:col-span-5 pr-0 md:pr-4">
                ...
                {/* Official Google OAuth Popup Trigger Button */}
                <div className="mt-5">
                  <button
                    type="button"
                    onClick={() => triggerGoogleLogin()}
                    className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-white border border-gray-300 rounded-full text-xs font-bold text-gray-700 hover:bg-gray-50 transition-all cursor-pointer shadow-2xs"
                  >
