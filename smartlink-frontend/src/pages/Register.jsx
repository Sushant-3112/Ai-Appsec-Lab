...
const Register = () => {
  ...
  // Direct 1-Click Google Authentication for instant registration/login
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-white font-sans">
      ...
      {/* Left Column: Linktree Style Sign Up Form */}
      <div className="w-full md:w-1/2 min-h-screen flex flex-col justify-between p-6 sm:p-10 lg:p-14 xl:p-16">
        ...
        <div className="max-w-md w-full mx-auto my-auto py-6">
          ...
          <p className="text-gray-500 font-medium text-sm mb-6">
            Sign up for your Ai Appsec lab
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <div>
              <div className="flex rounded-2xl shadow-2xs border border-gray-200 focus-within:ring-2 focus-within:ring-gray-900 focus-within:border-transparent overflow-hidden">
                <span className="inline-flex items-center px-4 bg-gray-50 text-gray-400 text-xs font-semibold select-none">
                  smartlink.hub/
                </span>
                <input
                  type="text"
                  ...
                  className="flex-1 block w-full px-3.5 py-3.5 text-sm focus:outline-none bg-white text-gray-900"
                />
              </div>
            </div>
            ...
            <div>
              <input
                ...
                className="w-full px-5 py-3.5 border border-gray-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent placeholder-gray-400 bg-white transition-all shadow-2xs"
              />
            </div>
